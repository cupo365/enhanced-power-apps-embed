define([], function() {
  return {
    ...
    PlaceholderDescription: "Embed a Power App on this page with SharePoint context parameters.",
    PlaceholderIconText: "Enhanced Microsoft Power Apps",
    PropertyPaneDescription: "Embed a Power App by pasting its web link or ID below.",
