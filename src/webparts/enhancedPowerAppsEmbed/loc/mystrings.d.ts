declare interface IEnhancedPowerAppsEmbedWebPartStrings {
...
declare module 'EnhancedPowerAppsEmbedWebPartStrings' {
  const strings: IEnhancedPowerAppsEmbedWebPartStrings;
  export = strings;
}
