...
import EnhancedPowerApps from "./components/EnhancedPowerAppsEmbed/EnhancedPowerAppsEmbed";
import { IEnhancedPowerAppsEmbedProps } from "./components/EnhancedPowerAppsEmbed/IEnhancedPowerAppsEmbedProps";
...
export interface IEnhancedPowerAppsEmbedWebPartProps {
...
export default class EnhancedPowerAppsEmbedWebPart extends BaseClientSideWebPart<IEnhancedPowerAppsEmbedWebPartProps> {
  ...
  public render(): void {
    ...
    const dynamicProp: string | undefined =
      this.properties.dynamicProp.tryGetValue();
    const locale: string = this._ctx.pageContext.cultureInfo.currentCultureName;
    ...
    const element: React.ReactElement<IEnhancedPowerAppsEmbedProps> =
      React.createElement(EnhancedPowerApps, {
        locale: locale,
